...
class Plain_bert(nn.Module):#
    def __init__(
        ...
        self.score3 = nn.Linear(embedding_dim, 1, bias=True)
    ...
    def forward(self , candidate_id , label,  rank_mask=None, gpu_tracker=None,last_state_only: bool = True):#
        ...
        return loss,torch.tensor(res.shape[0]).cuda()
