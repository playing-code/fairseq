...
class NewsIterator(object):
    ...
    def __init__(self, batch_size, npratio, feature_file, col_spliter=" ", ID_spliter="%",mode='train'):
        ...
        # if mode=='train':
        #     self.news_dict=read_features_roberta('/home/dihe/Recommenders/data/MINDlarge_train')
        # else:
        #     self.news_dict=read_features_roberta('/home/dihe/Recommenders/data/MINDlarge_dev')
    ...
    def parser_one_line(self, line):
        ...
        for news in cols:
            ...
            if "Impression" in tokens[0]:
                ...
                can_pos=[int(i) for i in tokens[1].split(",")]
                ...
                can_neg=[int(i) for i in self.news_dict[neg_list[neg_sample]][1:]]
                # candidate_news_index.append(w_temp)
                # assert len(w_temp)==512
    ...
    def _convert_data(
        ...
        #print('???',candidate_news_index_batch.shape)
